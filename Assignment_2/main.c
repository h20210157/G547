...
//---------------------User Space File Opening Function------------------------
...
//----------------User Space File CLosing Function----------------------------
...
//-----------------User Space File Reading Function--------------------------
...
//-----------------User Space File Writing Function--------------------------
...
//---------------------User Space file syncing function----------------
...
//strcpy(signature,data);
	...
	*(unsigned short *)(disk + MBR_SIGNATURE_OFFSET) = MBR_SIGNATURE;
        ...
        // make all data zero (i.e. till the size of the disk) that is in the openend file write zeros a given number of time 
        //file_write(struct file *file, unsigned long long offset, unsigned char *data, unsigned int size)

       // write the genuine data in the file 
       //file_write(dof_file, PARTITION_TABLE_OFFSET, (char*)&def_part_table, PARTITION_TABLE_SIZE);
...
//Module Information 
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Vishal Chekale <h20210157@pilani.bits-pilani.ac.in>");
MODULE_DESCRIPTION("Assigment 2 Block Device Driver using Disk on File");
